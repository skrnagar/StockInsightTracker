...
st.markdown("Enter a stock symbol to view financial data and metrics")

# Input for stock symbol
col1, col2 = st.columns([2, 1])
with col1:
    symbol = st.text_input("Enter Stock Symbol (e.g., AAPL, GOOGL)", value="")
with col2:
...
if symbol and search_button:
    ...
    st.info("👆 Enter a stock symbol above and click 'Search' to view the data")
